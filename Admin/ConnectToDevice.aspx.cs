...
{
    public partial class ConnectToDevice : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                case "151":
                    link = "Face registration";
                    control = Page.LoadControl("uc_ConnectToDevice_faceRegistration.ascx");
                    break;
                case "154":
                    link = "Device settings";
                    control = Page.LoadControl("uc_ConnectToDevice_deviceSettings.ascx");
                    break;
                case "157":
                    link = "Synchronize data";
                    control = Page.LoadControl("uc_ConnectToDevice_synchronizeData.ascx");
                    break;
