<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="uc_administrator_account.ascx.cs" Inherits="HLVTimeSheet.Admin.uc_administrator_account" %>
<!-- Main content -->
<section class="content">

<div class="box box-primary">
    <div class="box-header with-border" style='background-color: #dd4b39 !important;' >
    <h3 class="box-title" ><b style='color: #FFF;' ><%if (language.Equals("1")){ %>List of user <%} else if (language.Equals("2")) { %> Danh sách tài khoản <%} %></b></h3>
    </div>
    ...
    <div class="col-xs-12 col-sm-12 col-lg-12"> 
            <div class="row">
                <div class="col-xs-12 col-sm-8 col-lg-10">  
					<input type="text" class="form-control" id="txtTendonvi" placeholder="search follow user" runat="server" >
				</div>
				
				<div class="col-xs-12 col-sm-4 col-lg-2" style="text-align:right;" > 
                    <asp:LinkButton ID="lbTimkiem" runat="server" CssClass='btn btn-primary' onclick="lbTimkiem_Click" ><span class="glyphicon glyphicon-search" aria-hidden="true"></span> 
                        <%if (language.Equals("1")){ %>  Search <%} else if (language.Equals("2")){%> Tìm kiếm  <%} %>
                    </asp:LinkButton>
                    <%--<% if (quyen[2].Equals("1"))
                       { %> 
                    <a class="btn btn-success" href="Administrator.aspx?func=92&action=taomoi"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span> 
	...
	<div class="box-body table-responsive no-padding">
        ...
        <tr>
            <%if (language.Equals("1")){ %>
                ...
                <th style="text-align:center; width:22%;">Full name</th>
                ...
                <th style="text-align:center; width:3%;">#</th>
                <th style="text-align:center; width:15%;">Đăng nhập</th>
                <th style="text-align:center; width:22%;">Tên người dùng</th>
