...
{
    public partial class uc_administrator_division : System.Web.UI.UserControl
    {
        ...
        private void InitData()
        {
            ...
            string query = " SELECT a.pk_seq, a.ma, a.ten, a.trangthai, " +
                           ...
                           " FROM BoPhan a INNER JOIN  NhanVien c on a.nguoisua = c.pk_seq WHERE a.pk_seq > 0 ";
            ...
            for (int i = 0; i < dt.Rows.Count; i++)
            {
                ...
                if (language.Equals("1"))
                {
                    ...
                    if (quyen[ExecuteData.Xoa].Equals("1"))
                        noidung += "	    <i class='fa fa-fw fa-trash-o'></i> <a href='Administrator.aspx?func=99&action=delete&id=" + dt.Rows[i]["pk_seq"].ToString() + "' >Delete </a> &nbsp; ";
                ...
                else if (language.Equals("2"))
                {
                    ...
                    if (quyen[ExecuteData.Xoa].Equals("1"))
                        noidung += "	<i class='fa fa-fw fa-trash-o'></i> <a href='Administrator.aspx?func=99&action=delete&id=" + dt.Rows[i]["pk_seq"].ToString() + "' >Xóa </a> &nbsp; ";
                }
