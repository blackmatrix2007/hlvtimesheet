<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="uc_tochuc_chinhanh.ascx.cs" Inherits="HLVTimeSheet.Admin.uc_tochuc_chinhanh" %>
...
<div class="box box-primary">
    ...
    <h3 class="box-title" ><b style='color: #FFF;' ><%if (language.Equals("1")){ %>Information of branch <%} else if (language.Equals("2")) { %> Thông tin chi nhánh <%} %></b></h3>
    </div>
    <div class="box-body">
	...
	<div class="col-xs-12" > 
            <div class="row">
                <div class="col-xs-10">      
					<input type="text" class="form-control" id="txtTenLocation" placeholder="Seach follow branch " runat="server" >
				</div>
	...
	<div class="box-body table-responsive no-padding">
        ...
        <tr>
             <%if (language.Equals("1")){ %>			    
                ...
                <th style="text-align:center; width:16%;">Branch</th>
                ...
                <th style="text-align:center; width:16%;">Chi nhánh</th> 
	...
	<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel">
		...
		<div class="modal-content">
			...
			<h4 class="modal-title" id="exampleModalLabel"><%if (language.Equals("1")){ %>Information of branch detail <%} else if (language.Equals("2")) { %> Thông tin chi tiết <%} %></h4>
			</div>
			...
			<form>
                ...
                <div class="form-group">
				<label for="message-text" class="control-label"><%if (language.Equals("1")){ %> Address <%} else if (language.Equals("2")) { %> Địa chỉ <%} %>:</label>
                <textarea type="text" class="form-control" id="txtDiaChi" rows="3"></textarea>
				</div>
                <div class="form-group">
...
<script type="text/javascript" >
    function LuuThongTin() {
        ...
        //alert('STT: ' + stt);
        //CALL AJAX
        $.post("Hander/hdToChuc.ashx?action=UpdateBrand&id=" + id + "&ma=" + ma + "&ten=" + ten + "&diachi=" + diachi + "&trangthai=" + trangthai, function (result) {
            ...
            if (result == '') {
                ...
                window.location.replace("Administrator.aspx?func=31");
...
<script type="text/javascript" >
    function LayThongTin(id) {
        ...
        //CALL AJAX
        $.post("Hander/hdToChuc.ashx?action=GetInforBrand&id=" + id, function (result) {
            ...
            if (result != '') {
                ...
                document.getElementById("txtDiaChi").value = arr[2];
                ...
                <%if (language.Equals("1")){ %>
                alert("Cannot load information of branch. Please try again! ");
                 <%}
                else if (language.Equals("2")){ %>
