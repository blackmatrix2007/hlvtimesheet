<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="uc_administrator_position.ascx.cs" Inherits="HLVTimeSheet.Admin.uc_administrator_position" %>
...
<div class="box box-primary">
    ...
    <h3 class="box-title" ><b style='color: #FFF;' ><%if (language.Equals("1")){ %>Information of position <%} else if (language.Equals("2")) { %> Thông tin chức vụ <%} %></b></h3>
    </div>
    <div class="box-body">
	...
	<div class="col-xs-12" > 
            <div class="row">
                <div class="col-xs-10">      
					<input type="text" class="form-control" id="txtTenLocation" placeholder="Seach follow position " runat="server" >
				</div>
	...
	<div class="box-body table-responsive no-padding">
        ...
        <tr>
             <%if (language.Equals("1")){ %>			    
			    ...
			    <th style="text-align:center; width:3%;">#</th>
                <th style="text-align:center; width:8%;">Cấp bậc</th>
	...
	<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel">
		...
		<div class="modal-content">
			...
			<h4 class="modal-title" id="exampleModalLabel"><%if (language.Equals("1")){ %>Information of position detail <%} else if (language.Equals("2")) { %> Thông tin chi tiết <%} %></h4>
			</div>
			...
			<form>
				...
				<div class="form-group">
				<label for="message-text" class="control-label"><%if (language.Equals("1")){ %> Position <%} else if (language.Equals("2")) { %> Chức vụ <%} %>:</label>
                <input type="text" class="form-control" id="txtTen">
				</div>
                <div class="form-group">
				<label for="message-text" class="control-label"><%if (language.Equals("1")){ %> Level <%} else if (language.Equals("2")) { %> Cấp bậc <%} %>:</label>
                <asp:DropDownList ID="ddlCapBac" runat="server" Width="100%" CssClass='form-control' ></asp:DropDownList>
				</div>
                <div class="form-group">
...
<script type="text/javascript" >
    function LuuThongTin() {
        ...
        var capbac = document.getElementById("<%= ddlCapBac.ClientID %>").value;
        ...
        if (ten == '') {
            <%if (language.Equals("1")){ %> alert('Please, you must to input position!'); <%} else if (language.Equals("2")){ %> alert('Vui lòng nhập chi nhánh'); <%} %>
            return;
        }
        ...
        //alert('STT: ' + stt);
        //CALL AJAX
        $.post("Hander/hdToChuc.ashx?action=UpdatePosition&id=" + id + "&ma=" + ma + "&ten=" + ten + "&capbac=" + capbac + "&trangthai=" + trangthai, function (result) {
            ...
            if (result == '') {
                ...
                window.location.replace("Administrator.aspx?func=96");
...
<script type="text/javascript" >
    function LayThongTin(id) {
        ...
        $.post("Hander/hdToChuc.ashx?action=GetInforPosition&id=" + id, function (result) {
            ...
            if (result != '') {
                ...
                document.getElementById("<%= ddlCapBac.ClientID %>").value = arr[2];
                if (arr[3] == '1')
                ...
                <%if (language.Equals("1")){ %>
                alert("Cannot load information of position. Please try again! ");
                 <%}
                else if (language.Equals("2")){ %>
